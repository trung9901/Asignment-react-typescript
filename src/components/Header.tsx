                        ...
                        <div className="col-lg-8 col-xl-7 col-md-5 col-10 col-search order-3 order-md-2">
                            <div className="theme-search-smart">
                                <div className="header_search theme-searchs">
                                    <form action="/search" className="" role="search" onSubmit={handleSubmit(onSubmit)}>
                                        <input type="text" aria-label="Tìm sản phẩm" autoComplete="off" placeholder="Tìm kiếm sản phẩm..." {...register('q')} name="q" className="search-auto input-group-field auto-search" required />
