                                ...
                                <div className="swiper-wrapper bg-white">
                                    ...
                                    <div className="">
                                        <div className="cate-item">
                                            ...
                                            <h4 className="title_cate_"><a href="/phu-kien-thiet-bi-so" title="Phụ kiện - Thiết bị số">Phụ kiện - Thiết bị số</a></h4>
                                        </div>
                                    </div>
                                    <div className="">
                                        <div className="cate-item">
                                            <a className="image" href="/may-anh-quay-phim" title="Máy ảnh - Quay phim">
                                                <img className="image_cate_thumb lazyload" width={80} height={80} src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="//bizweb.dktcdn.net/thumb/small/100/429/689/collections/icon3.png?v=1623549208523" alt="Máy ảnh - Quay phim" />
                                            </a>
                                            <h4 className="title_cate_"><a href="/may-anh-quay-phim" title="Máy ảnh - Quay phim">Máy ảnh - Quay phim</a></h4>
                                        </div>
                                    </div>
                                    <div className="">
                                        <div className="cate-item">
                                            <a className="image" href="/dien-gia-dung-nha-bep" title="Điện gia dụng - Nhà bếp">
                                                <img className="image_cate_thumb lazyload" width={80} height={80} src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="//bizweb.dktcdn.net/thumb/small/100/429/689/collections/icon4s.png?v=1623549444870" alt="Điện gia dụng - Nhà bếp" />
                                            </a>
                                            <h4 className="title_cate_"><a href="/dien-gia-dung-nha-bep" title="Điện gia dụng - Nhà bếp">Điện gia dụng - Nhà bếp</a></h4>
                                        </div>
                                    </div>
                                    <div className="">
                                        <div className="cate-item">
                                            <a className="image" href="/laptop-thiet-bi-it" title="Laptop - Thiết bị IT">
                                                <img className="image_cate_thumb lazyload" width={80} height={80} src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="//bizweb.dktcdn.net/thumb/small/100/429/689/collections/icon5.png?v=1623549644967" alt="Laptop - Thiết bị IT" />
                                            </a>
                                            <h4 className="title_cate_"><a href="/laptop-thiet-bi-it" title="Laptop - Thiết bị IT">Laptop - Thiết bị IT</a></h4>
                                        </div>
                                    </div>
                                    <div className="">
                                        <div className="cate-item">
                                            <a className="image" href="/may-choi-game-tro-choi" title="Máy chơi game - Trò chơi">
                                                <img className="image_cate_thumb lazyload" width={80} height={80} src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="//bizweb.dktcdn.net/thumb/small/100/429/689/collections/icon6.png?v=1623549755877" alt="Máy chơi game - Trò chơi" />
                                            </a>
                                            <h4 className="title_cate_"><a href="/may-choi-game-tro-choi" title="Máy chơi game - Trò chơi">Máy chơi game - Trò chơi</a></h4>
                                        </div>
                                    </div>
                                    <div className="">
                                        <div className="cate-item">
                                            <a className="image" href="/trang-suc-sanh-dieu" title="Trang sức - Sành điệu">
                                                <img className="image_cate_thumb lazyload" width={80} height={80} src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="//bizweb.dktcdn.net/thumb/small/100/429/689/collections/icon7.png?v=1623549900997" alt="Trang sức - Sành điệu" />
                                            </a>
                                        ...
                                        {products?.map((product, index) => {
                                            return (<div className="col-lg-3 col-md-3 col-6" key={index}>
                                                <div className=" item_product_main">
                                                    <form action="/cart/add" method="post" className="variants product-action wishItem" data-cart-form data-id="product-actions-21989403" encType="multipart/form-data">
                                                        <div className="product-thumbnail sale " data-sale="Giảm 5% ">
                                                            <a className="image_thumb" href={`/product/${product.id}`} title="Samsung Galaxy Note 21">
                                                                <picture>
                                                        ...
                                                        <div className="product-info">
                                                            <h3 className="product-name"><a href={`/product/${product.id}`} title="Samsung Galaxy Note 21">{product.name}</a></h3>
                                                            <div className="price-box">
...
2% 
">
  <a className="image_thumb" href="/samsung-galaxy-s21-ultra" title="Samsung Galaxy S21 Ultra">
      <picture>
...
19% 
">
  <a className="image_thumb" href="/iphone-12-pro-max-chinh-hang" title="iPhone 12 Pro Max Chính Hãng">
      <picture>
          ...
          <img width={240} height={240} src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC" data-src="https://bizweb.dktcdn.net/100/429/689/products/iphone-12-pro-max-ba-c.jpg?v=1623565283000" alt="iPhone 12 Pro Max Chính Hãng" className="lazyload img-responsive center-block" />
      </picture>
  </a>
  <div className="product-action">
      <div className="group_action">
